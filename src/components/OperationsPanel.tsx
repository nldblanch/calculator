...
export const OperationsPanel = ({
  ...
  const handleEquals = () => {
    ...
    switch (operation) {
      case "+":
        setMemory((prev) => {return {...prev, num1: add(num1, num2)}})
        break;
      case "-":
        setMemory((prev) => {return {...prev, num1: subtract(num1, num2)}})
        break;
      case "/":
        if (num2 === 0) setOutput("Error");
        else {
          setMemory((prev) => {return {...prev, num1: divide(num1, num2)}})
        }
        break;
      case "*":
        setMemory((prev) => {return {...prev, num1: multiply(num1, num2)}})
        break;
    }
  };
  return (
